...
<template>
  <div class="admin-dashboard">
    ...
    <section class="hero relative text-white -mt-16">
      <!-- Background Overlay with Modern Gradient -->
      <div class="absolute inset-0 bg-gradient-to-r from-blue-900/80 via-indigo-800/80 to-blue-600/70 z-10"></div>
      ...
      <div class="container mx-auto px-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
          <div v-for="stat in stats" :key="stat.id" class="stat-card opacity-0">
            <div class="bg-white rounded-xl shadow-soft p-5 border-l-4" 
              ...
              <div class="flex justify-between items-start">
                ...
                <div :class="stat.trend === 'up' ? 'bg-green-100 text-green-700' : 'bg-red-100 text-red-700'" 
                    class="rounded-full p-2 icon-wrapper">
                  <svg v-if="stat.icon === 'users'" xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z" />
                  </svg>
                  <svg v-else-if="stat.icon === 'heart-pulse'" xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <div class="mt-3 flex items-center">
                <span :class="stat.trend === 'up' ? 'text-green-600' : 'text-red-600'" class="text-sm font-medium">{{ stat.change }}</span>
                <svg v-if="stat.trend === 'up'" xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 text-green-600 ml-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 7h8m0 0v8m0-8l-8 8-4-4-6 6" />
                </svg>
                <svg v-else xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 text-red-600 ml-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      <div class="container mx-auto px-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-5 max-w-5xl mx-auto">
          ...
          <div class="feature-card">
            ...
            <p class="card-text">
              Use our advanced AI models to diagnose cardiovascular risks and conditions with high accuracy
            </p>
          ...
          <div class="feature-card">
            ...
            <p class="card-text">
              View detailed history records, track progress, and monitor patient conditions over time
            </p>
          ...
          <div class="feature-card">
            ...
            <p class="card-text">
              Stay updated with the latest cardiovascular research, treatments, and medical advancements
            </p>
    ...
    <section class="expert-quote py-10 px-0 text-white">
      <div class="w-full">
        <div class="quote-content max-w-6xl mx-auto text-center px-4">
          <svg xmlns="http://www.w3.org/2000/svg" class="quote-mark mx-auto mb-2" width="36" height="36" fill="currentColor" viewBox="0 0 24 24">
            <path d="M14.017 21v-7.391c0-5.704 3.731-9.57 8.983-10.609l.995 2.151c-2.432.917-3.995 3.638-3.995 5.849h4v10h-9.983zm-14.017 0v-7.391c0-5.704 3.748-9.57 9-10.609l.996 2.151c-2.433.917-3.996 3.638-3.996 5.849h3.983v10h-9.983z" />
          </svg>
          
          <p class="quote-text mb-2">
            "Deteksi dini kondisi kardiovaskular sangat penting untuk pencegahan dan penanganan yang tepat. Platform JantungIn memberikan kemudahan bagi para tenaga medis dalam mengidentifikasi risiko secara proaktif dengan dukungan teknologi AI terkini."
          </p>
