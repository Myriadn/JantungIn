  ...
  <div class="history-page">
    ...
    <section class="relative">
      ...
      <div class="absolute inset-0">
        <div class="absolute inset-0 bg-cover bg-center hero-bg" style="background-image: url('/images/diagnose-hero.jpg'); filter: brightness(0.4);"></div>
        <div class="absolute inset-0 bg-gradient-to-r from-blue-900/70 via-indigo-800/60 to-blue-800/70"></div>
      ...
      <div class="relative z-10 py-16 px-4 text-center">
        ...
        <h1 class="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-4 tracking-tight">
          {{ selectedDiagnosis ? 'Diagnosis Details' : 'Your Personal' }} <span class="text-gradient">Health Records</span>
        </h1>
    ...
    <div class="bg-gradient-to-b from-blue-600 via-indigo-700 to-indigo-900 px-0 pt-10 pb-20 relative overflow-hidden">
      ...
      <div class="max-w-4xl mx-auto px-4 relative z-10">
        ...
        <!-- Loading State -->
        <div v-if="isLoading" class="bg-white/80 backdrop-blur-md rounded-xl shadow-lg p-8 text-center">
        ...
        <div v-else-if="!hasHistory" class="bg-white/80 backdrop-blur-md rounded-xl shadow-lg p-8">
          <div class="flex flex-col items-center text-center">
            ...
            <p class="text-gray-600 mb-6 max-w-md">Your doctor hasn't shared any diagnosis records with you yet. Records will appear here once available.</p>
            ...
            <div class="bg-blue-50 p-4 rounded-lg w-full max-w-md">
              ...
              <p class="text-sm text-blue-700">Regular health check-ups are important for early detection of heart conditions. We recommend scheduling a check-up at least once a year.</p>
            </div>
          </div>
        </div>
        ...
        <div v-else-if="!selectedDiagnosis">
          ...
          <div class="relative pb-2">
            ...
            <div class="absolute left-8 top-0 bottom-0 w-0.5 bg-gradient-to-b from-blue-400 to-indigo-500 hidden md:block"></div>
            ...
            <div class="space-y-6">
              ...
              >
                ...
                <div class="absolute left-8 top-6 transform -translate-x-1/2 w-4 h-4 rounded-full border-4 border-indigo-500 bg-white z-10 hidden md:block"></div>
                ...
                >
                  ...
                  <div class="p-5">
                    <div class="flex flex-wrap justify-between items-start gap-3 mb-3">
                      ...
                      <div
                        :class="{
                          'bg-green-100 text-green-800 border-green-200': diagnosis.resultPercentage < 20,
                          'bg-yellow-100 text-yellow-800 border-yellow-200': diagnosis.resultPercentage >= 20 && diagnosis.resultPercentage < 50,
                          'bg-red-100 text-red-800 border-red-200': diagnosis.resultPercentage >= 50
                        }"
                    ...
                    <div class="mt-4">
                      <div class="flex items-center mb-1">
                        ...
                        <span class="text-sm ml-3 font-medium">{{ diagnosis.resultPercentage }}%</span>
                      </div>
        ...
        <div v-else class="bg-white/90 backdrop-blur-md rounded-xl shadow-xl p-0 overflow-hidden">
          ...
          <div 
            :class="{
              ...
              'from-yellow-400 to-yellow-600': selectedDiagnosis.resultPercentage >= 20 && selectedDiagnosis.resultPercentage < 50,
              ...
              <div class="flex items-center">
                ...
                <div>
                  ...
                  <div class="flex items-center mt-1">
                    ...
                    <p class="text-sm opacity-90">{{ formatDate(selectedDiagnosis.sentAt || selectedDiagnosis.savedAt) }}</p>
                  </div>
                </div>
              </div>
          ...
          <div class="p-6">
            ...
            <div class="mb-6 bg-white rounded-xl shadow-sm overflow-hidden border border-gray-100">
              <div class="flex justify-between items-center bg-gray-50 px-4 py-3 border-b border-gray-100">
                ...
                <div 
                  :class="{
                    'bg-green-100 text-green-800 border-green-200': selectedDiagnosis.resultPercentage < 20,
                    'bg-yellow-100 text-yellow-800 border-yellow-200': selectedDiagnosis.resultPercentage >= 20 && selectedDiagnosis.resultPercentage < 50,
                    'bg-red-100 text-red-800 border-red-200': selectedDiagnosis.resultPercentage >= 50
                  }"
              ...
              <div class="p-4">
                  ...
                  <div class="relative pt-1">
                    <div class="flex mb-2 items-center justify-between">
                      <div>
                        <span 
                          :class="{
                            ...
                            'text-yellow-800': selectedDiagnosis.resultPercentage >= 20 && selectedDiagnosis.resultPercentage < 50,
                      ...
                      <div class="text-right">
                        <span class="text-xs font-semibold inline-block">{{ selectedDiagnosis.resultPercentage }}%</span>
                      </div>
                    </div>
                    ...
                    <div class="relative h-4 bg-gray-200 rounded-full overflow-hidden">
                      ...
                      <!-- Risk markers -->
                      <div class="absolute top-0 bottom-0 left-[20%] w-px bg-gray-400 opacity-70"></div>
                      <div class="absolute top-0 bottom-0 left-[50%] w-px bg-gray-400 opacity-70"></div>
                    </div>
                ...
                <div class="mt-4 pt-4 border-t border-gray-100">
                  <div class="flex">
                    <div 
                      :class="{
                        'bg-green-100 text-green-700 border-green-200': selectedDiagnosis.resultPercentage < 20,
                        'bg-yellow-100 text-yellow-700 border-yellow-200': selectedDiagnosis.resultPercentage >= 20 && selectedDiagnosis.resultPercentage < 50,
                        'bg-red-100 text-red-700 border-red-200': selectedDiagnosis.resultPercentage >= 50
                      }"
                    ...
                    <div>
                      ...
                      <p v-if="selectedDiagnosis.resultPercentage < 20" class="text-sm text-gray-700">
                        <span class="font-medium text-green-700">Low risk</span> of cardiovascular disease. Your heart health indicators are within normal ranges. Continue maintaining your healthy lifestyle and schedule regular check-ups to monitor your health.
                      </p>
                      <p v-else-if="selectedDiagnosis.resultPercentage < 50" class="text-sm text-gray-700">
                        <span class="font-medium text-yellow-700">Moderate risk</span> of cardiovascular disease. Consider lifestyle modifications such as improved diet, increased physical activity, and stress management. Regular follow-ups with your healthcare provider are recommended.
                      </p>
                      <p v-else class="text-sm text-gray-700">
                        <span class="font-medium text-red-700">High risk</span> of cardiovascular disease. The results indicate potential heart health concerns that require attention. We strongly recommend scheduling a consultation with a cardiologist for a comprehensive evaluation.
                      </p>
                    </div>
                  </div>
                </div>
            ...
            <div class="bg-white rounded-xl shadow-sm overflow-hidden border border-gray-100">
              <div class="bg-gradient-to-r from-blue-500 to-indigo-600 px-4 py-3 border-b border-blue-400">
              ...
              <div class="p-5">
                <p class="text-gray-700 mb-6">Based on your diagnosis results, here are personalized recommendations to improve your heart health:</p>
            ...
            <div class="mt-6 p-4 bg-blue-50 rounded-lg border border-blue-200 flex items-center">
              ...
              <div>
                ...
                <p class="text-sm text-blue-700">Schedule your next check-up in 3 months to monitor your heart health progress</p>
              </div>
            </div>
          </div>
        </div>
